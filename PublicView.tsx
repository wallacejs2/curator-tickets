...
// FIX: Import Shopper, Release, and EntityType types.
import { Ticket, Project, Dealership, Meeting, FeatureAnnouncement, Task, DealershipGroup, Shopper, Release, EntityType } from '../types.ts';
...
interface PublicViewProps {
  ...
  allData: {
    ...
    allShoppers: Shopper[];
    // FIX: Add allReleases to the allData type to pass down to child components.
    allReleases: Release[];
  };
}

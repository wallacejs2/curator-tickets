...
import { DealershipGroup } from '../types.ts';

interface DealershipGroupFormProps {
  onSave: (group: Omit<DealershipGroup, 'id' | 'dealershipIds'> | DealershipGroup) => void;
  onClose: () => void;
  groupToEdit?: DealershipGroup | null;
}

const getInitialState = (): Omit<DealershipGroup, 'id' | 'dealershipIds'> => ({
  name: '',
  description: '',
});

const DealershipGroupForm: React.FC<DealershipGroupFormProps> = ({ onSave, onClose, groupToEdit }) => {
...
export default DealershipGroupForm;